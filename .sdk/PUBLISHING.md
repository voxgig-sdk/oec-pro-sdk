...
|---|---|---|
| `ts/` | @voxgig-sdk/oec-pro-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/oec-pro-sdk \
      --repository voxgig-sdk/oec-pro-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/oec-pro-sdk` shows it, and
`npm trust revoke @voxgig-sdk/oec-pro-sdk --id=<id>` removes it.
