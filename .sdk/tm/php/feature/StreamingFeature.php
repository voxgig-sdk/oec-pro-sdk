...
class OecProStreamingFeature extends OecProBaseFeature
{
    ...
    private function _iterate(OecProResult $result): \Generator
    {
    ...
    private function _streamable(OecProContext $ctx): bool
    {
