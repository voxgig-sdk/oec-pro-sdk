...
// OecPro SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OecProOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OecProOmni::structfix($now, Struct::undef()))
                        !== json_encode(OecProOmni::structfix($val, Struct::undef()))) {
