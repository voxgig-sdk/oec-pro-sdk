...
class OecProFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OecProSDK/1.0)';
    ...
    public static function call(OecProContext $ctx, string $fullurl, array $fetchdef): array
    {
