...
_runner = makeRunner(TEST_JSON_FILE, OecProSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OecProSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OecProSDK.test(None, setup.get('a') or {})
