...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/oec-pro` | `npm install @voxgig-sdk/oec-pro` |
| Python | `voxgig-sdk-oec-pro` | `pip install voxgig-sdk-oec-pro` |
| PHP | `voxgig-sdk/oec-pro` | `composer require voxgig-sdk/oec-pro` |
| Golang | `github.com/voxgig-sdk/oec-pro-sdk/go` | `go get github.com/voxgig-sdk/oec-pro-sdk/go` |
| Ruby | `voxgig-sdk-oec-pro` | `gem install voxgig-sdk-oec-pro` |
| Lua | `voxgig-sdk-oec-pro` | `luarocks install voxgig-sdk-oec-pro` |
