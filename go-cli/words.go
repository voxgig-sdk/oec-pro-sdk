...
func registerSDKWords(r *eng.Registry, client *sdk.OecProSDK) {
...
func runOp(client *sdk.OecProSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
