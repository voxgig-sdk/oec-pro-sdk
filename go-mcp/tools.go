...
type Args struct {
	Entity string         `json:"entity" jsonschema:"country | product | trade"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OecProSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "oec-pro_list",
		Description: "List records from OecPro. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "oec-pro_load",
		Description: "Load a single record from OecPro. " +
...
func runOp(client *sdk.OecProSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OecProSDK, name string) (sdk.OecProEntity, error) {
