...
func (sdk *OecProSDK) OptionsMap() map[string]any {
...
func (sdk *OecProSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OecProSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OecProSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OecProSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OecProSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OecProSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OecProSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OecProSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OecProSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OecProSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
