...
const testSeed = `map[string]any{"entity": map[string]any{"country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trade": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
