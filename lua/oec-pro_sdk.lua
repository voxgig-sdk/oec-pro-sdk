...
OecProSDK._make_feature = _make_feature


function OecProSDK.new(options)
  local self = setmetatable({}, OecProSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OecProSDK:options_map()
...
function OecProSDK:get_utility()
  return Utility.copy(self._utility)
end


function OecProSDK:get_root_ctx()
  return self._rootctx
end


function OecProSDK:prepare(fetchargs)
...
function OecProSDK:direct(fetchargs)
...
-- by passing it.
function OecProSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OecProSDK:graphql(query, variables, ctrl)
...
function OecProSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OecProSDK.new(sdkopts)
  sdk.mode = "test"
