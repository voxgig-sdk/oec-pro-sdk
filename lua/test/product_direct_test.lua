...
describe("ProductDirect", function()
  it("should direct-list-product", function()
    local setup = product_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-product", setup.live and "live" or "unit")
...
function product_direct_setup(mockres)
