...
describe("TradeDirect", function()
  it("should direct-list-trade", function()
    local setup = trade_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-trade", setup.live and "live" or "unit")
