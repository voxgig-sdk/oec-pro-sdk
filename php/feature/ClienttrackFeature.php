...
// OecPro SDK clienttrack feature
...
class OecProClienttrackFeature extends OecProBaseFeature
{
    ...
    public function PostConstruct(OecProContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OecPro-SDK';
