...
class OecProProxyFeature extends OecProBaseFeature
{
    ...
    public function init(OecProContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OecProContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
