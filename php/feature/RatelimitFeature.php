...
class OecProRatelimitFeature extends OecProBaseFeature
{
    ...
    private function _acquire(OecProContext $ctx): void
    {
    ...
    private function _track(OecProContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
