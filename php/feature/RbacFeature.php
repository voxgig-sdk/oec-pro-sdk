...
class OecProRbacFeature extends OecProBaseFeature
{
    ...
    private function _required(OecProContext $ctx): ?string
    {
    ...
    private function _reject(OecProContext $ctx, string $required): void
    {
    ...
    private function _track(OecProContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
