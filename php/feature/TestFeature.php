...
// OecPro SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OecProTestFeature extends OecProBaseFeature
{
    ...
    public function init(OecProContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OecProContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OecProContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OecProContext $ctx, $op, $args): array
    {
