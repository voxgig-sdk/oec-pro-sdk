...
class OecProTimeoutFeature extends OecProBaseFeature
{
    ...
    private function _with_timeout(OecProContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OecProContext $_ctx, float $ms): void
    {
        $client = $this->client;
