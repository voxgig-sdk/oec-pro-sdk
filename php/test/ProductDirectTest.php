...
class ProductDirectTest extends TestCase
{
    public function test_direct_list_product(): void
    {
        $setup = product_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-product", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
