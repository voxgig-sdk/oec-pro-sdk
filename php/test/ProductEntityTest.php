...
class ProductEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OEC_PRO_TEST_PRODUCT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function product_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OEC_PRO_TEST_PRODUCT_ENTID");
