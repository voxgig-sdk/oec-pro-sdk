...
// OecPro SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OecProSDK::test)
...
{
    private const SDK_CLASS = 'OecProSDK';
    ...
    private const SDK_BASE = 'oecpro_sdk';
