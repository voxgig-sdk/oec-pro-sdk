...
{
    public function test_direct_list_trade(): void
    {
        $setup = trade_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-trade", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
