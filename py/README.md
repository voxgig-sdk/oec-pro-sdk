...
The Python SDK for the OecPro API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/oec-pro-sdk/releases)) or
