...
from oecpro_sdk.utility import register

# Load features
from oecpro_sdk.feature.base_feature import OecProBaseFeature
from oecpro_sdk.features import _has_feature, _make_feature
...
class OecProSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OecProUtility()
        self._utility = utility

        from oecpro_sdk.config import shared_config
    ...
    def get_utility(self):
        return OecProUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OecProSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Country(self, data=None) -> "CountryEntity":
        ...
        from oecpro_sdk.entity.country_entity import CountryEntity
