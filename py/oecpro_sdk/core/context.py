...
from oecpro_sdk.core.helpers import get_ctx_prop, to_map
...
class OecProContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, OecProResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OecProError(code, msg, self)
