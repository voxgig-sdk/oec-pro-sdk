# OecPro SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OecProSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OecProSDK(...) and OecProSDK.test(...) become
#      OecProSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "oecpro_sdk"
_SDK_CLASS = "OecProSDK"
