...
(0, node_test_1.describe)('TradeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-trade', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-trade', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OEC_PRO_TEST_TRADE_ENTID'];
