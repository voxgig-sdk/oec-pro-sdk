...
(0, node_test_1.describe)('TradeEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.OecProSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        const trade_ref01_match = {};
        const trade_ref01_list = (await trade_ref01_ent.list(trade_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    let client = __1.OecProSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.OecProSDK(merge([
