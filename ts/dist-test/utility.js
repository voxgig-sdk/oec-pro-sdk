...
function envOverride(m) {
    if ('TRUE' === process.env.OEC_PRO_TEST_LIVE ||
        'TRUE' === process.env.OEC_PRO_TEST_OVERRIDE) {
    ...
    m.OEC_PRO_TEST_EXPLAIN = process.env.OEC_PRO_TEST_EXPLAIN || m.OEC_PRO_TEST_EXPLAIN;
    return m;
}
